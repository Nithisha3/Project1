...
<html>
	...
	<body>
		...
		<div class ="col-md-6 text1">
					...
					The current role doesn't have any Claim attached to it with the given claim Id or the user don't have permission to access it.
		</div>
		<!-- FOOTER STARTS-->
